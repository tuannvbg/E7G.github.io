...
function newTips(){
        $.XYTipsWindow({
            ___title:"Tips效果",
			___triggerID:"header",
            ___content:"text:<p style='margin:1px;padding:8px;background:#ffffff'>齐享云上线啦~~<br />免费,高速,快捷,简单<br />为用户提供高速免费网盘<br />高速简洁客户端<a href=http://www.niouzhan.com/文件分享.exe target=_blank >[下载]</a></p>",
            ___width:"200",
            ___height:"",
            ___showTitle:false,
            ___showBoxbg:false,
            ___boxWrapBdColor:"#38befd",
            ___closeID:"colseTipsLayer",
            ___offsets:{left:"1050px",top:"120px"},
            ___fns:function(){
